...
public:
    ...
    GeometryStage(
        ...
        , m_mesh{
            renderer.device(), 
            // Custom Model
            // std::move(g_resources.load<MeshData>("models://damaged_helmet.glb")->vertices)
