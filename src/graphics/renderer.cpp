...
PerFrameData::PerFrameData(vk::Device& device, vk::CommandPool& cmd_pool)
    ...
    img_available = vk::create_semaphore(*m_device_ptr);
    finished_render = vk::create_semaphore(*m_device_ptr);
    in_flight_fence =
...
PerFrameData::~PerFrameData() {
    if (in_flight_fence != VK_NULL_HANDLE) {
        vk::destroy_semaphore(*m_device_ptr, img_available);
        vk::destroy_semaphore(*m_device_ptr, finished_render);
