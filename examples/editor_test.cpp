...
void set_theme() {
    ...
    // style->Colors[ImGuiCol_CloseButton]        = ImVec4(0.40f, 0.39f, 0.38f,
    // 0.16f); style->Colors[ImGuiCol_CloseButtonHovered] = ImVec4(0.40f, 0.39f,
    // 0.38f, 0.39f); style->Colors[ImGuiCol_CloseButtonActive]  = ImVec4(0.40f,
    // 0.39f, 0.38f, 1.00f);
